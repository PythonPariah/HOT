...
contract MoneyShot is Context, IERC20, Ownable {
    ...
    address private _DeveloperWalletAddress =0xDA530b54E58c2CEd0e23e29A439d0844A0Cc3783 ;
    ...
    uint256 public _taxFee = 20; // 4 % 
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _DeveloperFee = 5; // .5%
    uint256 private _previousDeveloperFee = _DeveloperFee;
    uint256 public _liquidityFee = 20; // 2%
    ...
    uint256 private numTokensSellToAddToLiquidity = 696969696  * 10**9;
...
// Bot Functions 
    ...
    function setDeveloperAddress(address newAdd) external onlyOwner() {
        _DeveloperWalletAddress = newAdd;
    }
